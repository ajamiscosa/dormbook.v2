...
@section('content')
<form method="POST" action="/dorm/{{$data->ID}}/update" enctype="multipart/form-data">
    {{ csrf_field() }}
                            ...
                            <div class="profileIntro paraMargin">
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-8 col-xs-12">
                                        ...
                                        <input type="text" class="form-control" id="dormName" placeholder="Listing Title" name="Name" required value="{{ $data->Name }}">
                                    </div>
                                    <div class="form-group col-sm-4 col-xs-12">
                                        <label for="listingCategory">Campus</label>
                                        <div class="contactSelect">
                                            <select id="CampusSelect" class="select-drop" required value="{{ $data->Name }}">
                                    ...
                                    <div class="form-group col-sm-4 col-xs-12">
                                        ...
                                        <input type="text" class="form-control" placeholder="# of Rooms" name="Rooms" required value="{{ $data->Rooms }}">
                                    </div>
                                    <hr/>
                                    <div class="form-group col-sm-4 col-xs-12">
                                        <label for="listingTitle">Monthly Rate (per head)</label>
                                        <input type="number" class="form-control" placeholder="Monthly Rate (per head)" name="Rate" required value="{{ $data->Rate }}">
                                    </div>
                                    <hr/>
                                    <div class="form-group col-sm-4 col-xs-12">
                                        <label for="listingTitle">Business Permit ID</label>
                                        <input type="text" class="form-control" placeholder="Business Permit" name="BusinessPermit" required value="{{ $data->BusinessPermit }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="profileIntro paraMargin">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-6 col-xs-12">
                                        ...
                                        <div class="contactSelect">
                                            <input type="text" class="form-control" id="Owner" name="Owner" placeholder="Owner's Name" autocomplete="off" required value="{{ $data->Owner }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-sm-6 col-xs-12">
                                        ...
                                        <div class="contactSelect">
                                            <input type="text" class="form-control" id="AddressLine1" name="AddressLine1" placeholder="Type Location" autocomplete="off" required value="{{ $data->AddressLine1 }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-sm-6 col-sm-6 col-xs-12">
                                        ...
                                        <input type="text" class="form-control" id="AddressLine2" name="AddressLine2" placeholder="" value="{{ $data->AddressLine2 }}">
                                    </div>
                                    <div class="form-group col-sm-6 col-sm-6 col-xs-12">
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <label for="listingEmail">City</label>
                                                <input type="text" class="form-control" id="City" name="City" placeholder=""  value="{{ $data->City }}" readonly>
                                            </div>
                                            <div class="col-lg-4">
                                                <label for="listingEmail">Zip</label>
                                                <input type="number" class="form-control" id="Zip" name="Zip" placeholder="" value="{{ $data->Zip }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-sm-6 col-sm-6 col-xs-12">
                                        <label for="listingWebsite">Mobile Number</label>
                                        <input type="text" class="form-control" id="MobileNumber" name="MobileNumber" placeholder="" required value="{{ $data->MobileNumber }}">
                                    </div>
                                    <div class="form-group col-sm-6 col-sm-6 col-xs-12">
                                        <label for="listingWebsite">Land Line Number</label>
                                        <input type="text" class="form-control" id="LandLineNumber" name="LandLineNumber" placeholder="" required value="{{ $data->LandLineNumber }}">
                                    </div>
                                </div>
                            </div>
                        </div>
...
//        marker: L.circleMarker([0,0],{radius:30}),
        ...
        var name = '<strong>{{ $data->Name }}</strong><br/>'+
                ...
                '{{ $data->City }}, Cavite<br/>{{ $data->Rate }}<br/>' +
                '<img src="/uploads/{{ $data->ID }}/1.jpg" style="max-height: 100px; max-width: 100px;"/>';


            L.marker(['{{ $data->Latitude }}', '{{ $data->Longitude }}']).addTo(mymap).bindPopup(name)
                .openPopup();
